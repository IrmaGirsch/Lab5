class Main {
  public static void main(String[] args) {
    ...
    System.out.println("36 is in this tree: " + lab5Tree.search(36));

    // Step 8 - Display the result of a search for the value 37
    System.out.println("37 is in this tree: " + lab5Tree.search(37));

    // Step 9 - Using the path() method, display the path from the root to 2
    System.out.println("Path from the root to 2: " + lab5Tree.path(2).toString());
